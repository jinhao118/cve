...
![](C:\Users\user\AppData\Roaming\marktext\images\2026-01-18-16-41-36-image.png)

通过调用`/api/ZRMacClone/mac_addr_clone`可以调用到`macAddrClone`，这里设置了全局变量`g_debug`为`true`，发现`logger`方法可以用来进行命令注入，下面是`macAddrClone`方法。

![](C:\Users\user\AppData\Roaming\marktext\images\2026-01-18-16-44-26-image.png)
...
![](C:\Users\user\AppData\Roaming\marktext\images\2026-01-18-16-51-14-image.png)
